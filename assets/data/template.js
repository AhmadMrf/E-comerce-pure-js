export const PRODUCT_PRE_LOADER = `
...
export const SINGLE_PRODUCT_PRE_LOADER = `
<div class="pre-loader single-product-image-wrapper">
  ...
  <div class="pre-loader single-product-info-wrapper">
    <div class="product-content"></div>
    <div class="add-to-cart-content">
    <button class="button button-dark title"></button>
    </div>
  </div>
`;
export const REVIEW_PRE_LOADER = `
<div class="pre-loader swiper-slide review-info">
